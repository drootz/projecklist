        ...
        <div class="m-login">
            <fieldset>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-pad-12">
                            ...
                            <button id="js-delete-cancelbtn" class="button">Cancel</button>
                            <hr />
                ...
                <div class="m-login-button">
                    <br/>
                    <button class="button" type="submit" value="submit" id="f-delete-account" name="submit">DELETE ACCOUNT NOW</button>
                </div>
