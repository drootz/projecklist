...
<div id="f-section-form" class="f-section-form th-divider view-form">
    ...
    <form id="projecklist" class="form" method="post" action="?" autocomplete="off">
        ...
        <section id="f-section-planning" class="f-section-planning">
            ...
            <?php if (!empty($pid)): ?>
            <input class="visuallyhidden" type="number" name="f_pid_exist" id="f-pid-exist" maxlength="10" value="<?= $pid ?>"/>
            <?php endif ?>
                            ...
                            <div class="m-site">
                                <div class="js-fieldset-1 is-visible">
                                    <div>
                                        ...
                                        <input type="text" name="fld_project_name" id="f-project-name" autocomplete="off" maxlength="150" required <?php if (!empty($pname)): ?> value="<?= $pname ?>" <?php endif ?>/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="l-main-fieldset">
                    <fieldset>
                        <div class="m-inquiry-block">
                            <legend class="m-inquiry-title">
                                <span class="js-toggle-info m-btn-info fa fa-info fa-lg"></span>
                                <span><?php //_( 'form-planning-tc-ttl' ); ?></span>
                            </legend>

                            <div class="m-block-info">
                                <blockquote class="slide-left">
                                    <p><?php //_( 'form-planning-tc-info' ); ?></p>
                                </blockquote>
                            </div>
                        </div>
                        ...
                        <div class="m-inputfield-wrapper">
                            <div class="l-check-container f-tc-container">
                                <label for="f-condition" class="f-tc-label"><?php //_( 'bol_t_and_c_reviewed' ); ?></label>
                ...
                <div class="m-sub-wrapper">
                    ...
                    <fieldset class="is-relative m-sub-fieldset-inquiry">
                        <div class="m-hours-block m-range js-hours-block">
                            ...
                            <select id="f-hours-set-1" name="hra_hours_1">
                                <!-- <optgroup 
                                <?php 
                        ...
                        <select id="f-hours-set-start-hour-1" name="hhm_hours_sh_1">
                        ...
                        <select id="f-hours-set-start-min-1" name="hhm_hours_sm_1">
                        ...
                        <select id="f-hours-set-end-hour-1" name="hhm_hours_eh_1">
                        ...
                        <select id="f-hours-set-end-min-1" name="hhm_hours_em_1">
                        ...
                        <div class="l-check-container m-hours-block m-closed">
                            <input type="checkbox" name="cbx_hours_closed_1" id="f-hours-set-closed-1" class="js-hours-closed" value="closed">
                    ...
                    <fieldset class="is-relative m-sub-fieldset-inquiry">
                        ...
                        <div class="m-hours-block m-range js-hours-block">
                            ...
                            <select id="f-hours-set-2" name="hra_hours_2">
                        ...
                        <select id="f-hours-set-start-hour-2" name="hhm_hours_sh_2">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-start-min-2" name="hhm_hours_sm_2">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <select id="f-hours-set-end-hour-2" name="hhm_hours_eh_2">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-end-min-2" name="hhm_hours_em_2">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <div class="l-check-container m-hours-block m-closed">
                            <input type="checkbox" name="cbx_hours_closed_2" id="f-hours-set-closed-2" class="js-hours-closed" value="closed">
                    ...
                    <fieldset class="is-relative m-sub-fieldset-inquiry">
                        ...
                        <div class="m-hours-block m-range js-hours-block">
                            ...
                            <select id="f-hours-set-3" name="hra_hours_3">
                        ...
                        <select id="f-hours-set-start-hour-3" name="hhm_hours_sh_3">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-start-min-3" name="hhm_hours_sm_3">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <select id="f-hours-set-end-hour-3" name="hhm_hours_eh_3">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-end-min-3" name="hhm_hours_em_3">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <div class="l-check-container m-hours-block m-closed">
                            <input type="checkbox" name="cbx_hours_closed_3" id="f-hours-set-closed-3" class="js-hours-closed" value="closed">
                    ...
                    <fieldset class="is-relative m-sub-fieldset-inquiry">
                        ...
                        <div class="m-hours-block m-range js-hours-block">
                            ...
                            <select id="f-hours-set-4" name="hra_hours_4">
                        ...
                        <select id="f-hours-set-start-hour-4" name="hhm_hours_sh_4">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-start-min-4" name="hhm_hours_sm_4">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <select id="f-hours-set-end-hour-4" name="hhm_hours_eh_4">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-end-min-4" name="hhm_hours_em_4">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <div class="l-check-container m-hours-block m-closed">
                            <input type="checkbox" name="cbx_hours_closed_4" id="f-hours-set-closed-4" class="js-hours-closed" value="closed">
                    ...
                    <fieldset class="is-relative m-sub-fieldset-inquiry">
                        ...
                        <div class="m-hours-block m-range js-hours-block">
                            ...
                            <select id="f-hours-set-5" name="hra_hours_5">
                        ...
                        <select id="f-hours-set-start-hour-5" name="hhm_hours_sh_5">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-start-min-5" name="hhm_hours_sm_5">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <select id="f-hours-set-end-hour-5" name="hhm_hours_eh_5">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-end-min-5" name="hhm_hours_em_5">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <div class="l-check-container m-hours-block m-closed">
                            <input type="checkbox" name="cbx_hours_closed_5" id="f-hours-set-closed-5" class="js-hours-closed" value="closed">
                    ...
                    <fieldset class="is-relative m-sub-fieldset-inquiry">
                        ...
                        <div class="m-hours-block m-range js-hours-block">
                            ...
                            <select id="f-hours-set-6" name="hra_hours_6">
                        ...
                        <select id="f-hours-set-start-hour-6" name="hhm_hours_sh_6">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-start-min-6" name="hhm_hours_sm_6">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <select id="f-hours-set-end-hour-6" name="hhm_hours_eh_6">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-end-min-6" name="hhm_hours_em_6">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <div class="l-check-container m-hours-block m-closed">
                            <input type="checkbox" name="cbx_hours_closed_6" id="f-hours-set-closed-6" class="js-hours-closed" value="closed">
                    ...
                    <fieldset class="is-relative m-sub-fieldset-inquiry">
                        ...
                        <div class="m-hours-block m-range js-hours-block">
                            ...
                            <select id="f-hours-set-7" name="hra_hours_7">
                        ...
                        <select id="f-hours-set-start-hour-7" name="hhm_hours_sh_7">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-start-min-7" name="hhm_hours_sm_7">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <select id="f-hours-set-end-hour-7" name="hhm_hours_eh_7">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-hours' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00h</option>
                                    <option value="01">01h</option>
                        ...
                        <select id="f-hours-set-end-min-7" name="hhm_hours_em_7">
                                <optgroup <?= "label=\"" . _( 'form-planning-hours-from-lbl-minutes' ) . "\""; ?> >
                                    <option disabled selected value="">--</option>
                                    <option value="00">00</option>
                                    <option value="15">15</option>
                        ...
                        <div class="l-check-container m-hours-block m-closed">
                            <input type="checkbox" name="cbx_hours_closed_7" id="f-hours-set-closed-7" class="js-hours-closed" value="closed">
