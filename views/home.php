            ...
            <div class="l-wrapper l-action-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-04 m-action-block">
                        ...
                        <h4 class="js-ico-debug"><span><?= _( 'action-first-ttl' ); ?></span></h4>
                        <p><?= _( 'action-first-txt' ); ?></p>
                    ...
                    <div class="col-04 m-action-block">
                        ...
                        <h4 class="js-ico-debug"><span><?= _( 'action-second-ttl' ); ?></span></h4>
                        <p><?= _( 'action-second-txt' ); ?></p>
                    ...
                    <div class="col-04 m-action-block">
                        ...
                        <h4 class="js-ico-debug"><span><?= _( 'action-third-ttl' ); ?></span></h4>
                        <p><?= _( 'action-third-txt' ); ?></p>
            ...
            <div class="l-wrapper">
                <div class="row">
                    ...
                    <div class="col-08 m-intro-art">
                        ...
                        <h2><?= _( 'form-intro-ttl' ); ?></h2>

                        <p><?= _( 'form-intro-pra-validate' ); ?></p>
                        <p><?= _( 'form-intro-pra-design' ); ?></p>
