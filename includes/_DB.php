...
* Filename: DB.php
*
* Description: Database handling class
*
...
* 
* Copyright (c) 2016
* Daniel Racine <mailto.danielracine@gmail.com>
* All Rights Reserved
*/
    ...
    class DB
    {
        ...
        /**
         * Initializes database with JSON file at $path.
         */
        ...
        public static function query(/* $sql [, ... ] */)
        {
            ...
            if (!isset(self::$config))
            {
                trigger_error("DB Library is not initialized", E_USER_ERROR);
            }
